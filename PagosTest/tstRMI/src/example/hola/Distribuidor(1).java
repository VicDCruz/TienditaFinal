...
public class Distribuidor {
    ...
    public static void main(String args[]) {
        ...
        if (args.length == 0) {
            ...
            if (args[0].compareToIgnoreCase("Cliente") == 0) {
                Client.main(argsPar);
            }
            if (args[0].compareToIgnoreCase("Server") == 0) {
                Server.main(argsPar);
            }
            if (args[0].compareToIgnoreCase("ServidorDeDisparo") == 0) {
                ServidorDeDisparo.main(argsPar);
            }
            if (args[0].compareToIgnoreCase("TestOperaciones") == 0) {
                TestOperaciones.main(argsPar);
            }
            if (args[0].compareToIgnoreCase("TestModulo") == 0) {
                TestOperaciones.main(argsPar);
            }
        }
